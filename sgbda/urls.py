...
from .views.informacion import informacion_motores, mantenimientos_SqlServer, Mover_datafiles, Instalar_Postgresql, Data_warehouse, SQL_avanzado, Modelamiento_dimensional
...
urlpatterns = [
    ...
    path("Modelamiento_dimensional/", Modelamiento_dimensional, name="Modelamiento_dimensional"),
